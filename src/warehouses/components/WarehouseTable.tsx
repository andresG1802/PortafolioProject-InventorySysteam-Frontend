...
export const WarehouseTable = ({ warehouses, onEdit, onDelete }: WarehouseTableProps) => (
        ...
        <tbody className="divide-y divide-slate-800">
          <AnimatePresence initial={false}>
            {warehouses.map((warehouse) => (
              ...
              >
                <td className="px-5 py-3 font-medium text-slate-100">{warehouse.name}</td>
                <td className="px-5 py-3 text-slate-400">{warehouse.location || '—'}</td>
